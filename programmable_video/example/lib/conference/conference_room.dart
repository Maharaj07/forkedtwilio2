...
class ConferenceRoom with ChangeNotifier {
  ...
  void _addOrUpdateParticipant(RemoteParticipantEvent event) {
    ...
    if (participant != null) {
      ...
      if (event is RemoteVideoTrackEvent) _setRemoteVideoEnabled(event as RemoteVideoTrackEvent);
      if (event is RemoteAudioTrackEvent) _setRemoteAudioEnabled(event as RemoteAudioTrackEvent);
    } else {
